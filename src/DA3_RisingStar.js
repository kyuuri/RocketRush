var DA3_RisingStar = DropAlgorithm.extend({
    ...
    playCutInName: function(){
        this.cutin = new CutIn();
        this.cutin.initWithFile( 'images/risingStar.png' );
        this.gameLayer.addChild( this.cutin, 100 );
        this.cutin.setPosition( new cc.p( screenWidth + 420, screenHeight / 2 ) );
        this.cutin.play();
    },
    ...
    firstSet: function(){
        ...
        if( this.rateTime == 100 ){
            ...
            this.obstacleCreators[0].setPosition( new cc.Point( screenWidth - 50, 50 ));
            this.obstacleCreators[1].setPosition( new cc.Point( 50, 50 ));
            this.obstacleCreators[2].setPosition( new cc.Point( screenWidth / 2, 50 ));
            this.obstacleCreators[3].setPosition( new cc.Point( screenWidth / 2, 50 ));
            this.obstacleCreators[4].setPosition( new cc.Point( screenWidth / 2, 50 ));
            this.obstacleCreators[4].obstacles[0] = ( new AdvancedObstacle1() ) ;
            this.obstacleCreators[5].setPosition( new cc.Point( screenWidth / 2, 50 ));
            this.obstacleCreators[5].obstacles[0] = ( new AdvancedObstacle1() ) ;
            this.obstacleCreators[6].setPosition( new cc.Point( screenWidth / 2, 50 ));
    ...
    secondSet: function(){
        ...
        if( this.second ){
            ...
            if( this.rateTime % 5 == 0){
                ...
                new cc.Point( (screenWidth / 10) * ( this.ndRunner + 1 ) - 25 , 50 ));
        ...
        if( this.rateTime == 500 || this.rateTime == 600 || this.rateTime == 700 ){
            ...
            this.obstacleCreators[20].shootMultiArc( 4, 0, 0, 0, 18, 60);
        ...
        if( this.rateTime == 550 || this.rateTime == 650 || this.rateTime == 750 ){
            ...
            this.obstacleCreators[29].shootMultiArc( 4, 0, 0, 0, 18, 120);
            //this.obstacleCreators[28].shootLockOn( 0, 0, 0, 18 );
        }
